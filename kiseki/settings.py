"""
Django settings for kiseki project.
...
SECRET_KEY = 'django-insecure-a&_=*@9c_s5(d3z08tklf*y_yzbnm&nr8a7#soh%@wgg27e2_m'
...
WSGI_APPLICATION = 'kiseki.wsgi.application'
